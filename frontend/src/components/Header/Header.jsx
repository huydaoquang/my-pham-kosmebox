...
const Header = () => {
  return (
    <header className="max-w-7xl ">
      ...
      <div className="flex justify-center gap-10  mt-1  relative">
        <Link to="/">
        ...
        <div className="flex items-end w-80 relative">
          <input
            ...
            className="border-solid border-2 border-red-500 outline-none rounded-3xl text-sm px-4 py-2 w-full"
          />
          <BsSearch
